...
-- Date        : Tue Apr 23 10:22:09 2024
-- Host        : LAPTOP-KMHA882Q running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/14086/Documents/topper/projs/git/github/rdl1/rdl1.gen/sources_1/bd/design_1/ip/design_1_ip_pwmr_0_0/design_1_ip_pwmr_0_0_sim_netlist.vhdl
...
entity design_1_ip_pwmr_0_0_pwm_measurement is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_ip_pwmr_0_0_pwm_measurement : entity is "pwm_measurement";
end design_1_ip_pwmr_0_0_pwm_measurement;

architecture STRUCTURE of design_1_ip_pwmr_0_0_pwm_measurement is
  ...
  signal \pwmMsrCnt[0]_i_3_n_0\ : STD_LOGIC;
  signal pwmMsrCnt_reg : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal \pwmMsrCnt_reg[0]_i_2_n_0\ : STD_LOGIC;
  signal \pwmMsrCnt_reg[0]_i_2_n_1\ : STD_LOGIC;
  signal \pwmMsrCnt_reg[0]_i_2_n_2\ : STD_LOGIC;
  signal \pwmMsrCnt_reg[0]_i_2_n_3\ : STD_LOGIC;
  signal \pwmMsrCnt_reg[0]_i_2_n_4\ : STD_LOGIC;
  signal \pwmMsrCnt_reg[0]_i_2_n_5\ : STD_LOGIC;
  signal \pwmMsrCnt_reg[0]_i_2_n_6\ : STD_LOGIC;
  signal \pwmMsrCnt_reg[0]_i_2_n_7\ : STD_LOGIC;
  ...
  signal \pwmMsr[31]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute ADDER_THRESHOLD of \pwmMsrCnt_reg[0]_i_2\ : label is 11;
...
\pwmMsrCnt[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"4F"
    )
        port map (
...
\pwmMsrCnt[0]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => pwmMsrCnt_reg(0),
      O => \pwmMsrCnt[0]_i_3_n_0\
    );
\pwmMsrCnt_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => fsm,
      D => \pwmMsrCnt_reg[0]_i_2_n_7\,
      Q => pwmMsrCnt_reg(0),
      R => \pwmMsrCnt[0]_i_1_n_0\
    );
\pwmMsrCnt_reg[0]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \pwmMsrCnt_reg[0]_i_2_n_0\,
      CO(2) => \pwmMsrCnt_reg[0]_i_2_n_1\,
      CO(1) => \pwmMsrCnt_reg[0]_i_2_n_2\,
      CO(0) => \pwmMsrCnt_reg[0]_i_2_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0001",
      O(3) => \pwmMsrCnt_reg[0]_i_2_n_4\,
      O(2) => \pwmMsrCnt_reg[0]_i_2_n_5\,
      O(1) => \pwmMsrCnt_reg[0]_i_2_n_6\,
      O(0) => \pwmMsrCnt_reg[0]_i_2_n_7\,
      S(3 downto 1) => pwmMsrCnt_reg(3 downto 1),
      S(0) => \pwmMsrCnt[0]_i_3_n_0\
    );
...
\pwmMsr[31]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => fsm,
      I1 => pwmIn,
      O => \pwmMsr[31]_i_1_n_0\
    );
\pwmMsr_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => \pwmMsr[31]_i_1_n_0\,
      D => pwmMsrCnt_reg(0),
      Q => pwmMsr(0),
      R => \^sr\(0)
    );
...
\staleCnt[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"04FF"
    )
        port map (
...
\staleCnt[0]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_ip_pwmr_0_0_ip_pwmr_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_ip_pwmr_0_0_ip_pwmr_v1_0_S00_AXI : entity is "ip_pwmr_v1_0_S00_AXI";
end design_1_ip_pwmr_0_0_ip_pwmr_v1_0_S00_AXI;

architecture STRUCTURE of design_1_ip_pwmr_0_0_ip_pwmr_v1_0_S00_AXI is
...
pwmr_inst: entity work.design_1_ip_pwmr_0_0_pwm_measurement
     port map (
      ...
      \axi_rdata_reg[0]_1\(3 downto 0) => sel0(3 downto 0),
      \axi_rdata_reg[0]_2\ => \axi_rdata[0]_i_4_n_0\,
      ...
      \axi_rdata_reg[31]_0\(31 downto 0) => slv_reg9(31 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_ip_pwmr_0_0_ip_pwmr_v1_0 is
  port (
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_ip_pwmr_0_0_ip_pwmr_v1_0 : entity is "ip_pwmr_v1_0";
end design_1_ip_pwmr_0_0_ip_pwmr_v1_0;

architecture STRUCTURE of design_1_ip_pwmr_0_0_ip_pwmr_v1_0 is
begin
ip_pwmr_v1_0_S00_AXI_inst: entity work.design_1_ip_pwmr_0_0_ip_pwmr_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_ip_pwmr_0_0 is
  port (
    pwmIn : in STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_aresetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_ip_pwmr_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_ip_pwmr_0_0 : entity is "design_1_ip_pwmr_0_0,ip_pwmr_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_ip_pwmr_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_ip_pwmr_0_0 : entity is "ip_pwmr_v1_0,Vivado 2020.2";
end design_1_ip_pwmr_0_0;

architecture STRUCTURE of design_1_ip_pwmr_0_0 is
...
inst: entity work.design_1_ip_pwmr_0_0_ip_pwmr_v1_0
     port map (
