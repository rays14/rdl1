...
(
    ...
    output     [DATA_BUS_SIZE - 1 : 0] rdDataOut;
    input                              wrLowIn;
    ...
    initial
    begin
        for (i = 0; i < (NUM_DATA_ITEMS - 1); i = i + 1)
        begin
            memr[i] <= 0;
        end
    end

    assign rdDataOut = memr[rdAddrIn];
