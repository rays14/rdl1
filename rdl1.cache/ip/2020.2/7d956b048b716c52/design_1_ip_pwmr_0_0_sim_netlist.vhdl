...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm_measurement is
  ...
  signal samplingCnt_reg : STD_LOGIC_VECTOR ( 0 to 0 );
...
fsm_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F4"
    )
        port map (
...
\pwmMsrCnt[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"40FF"
    )
        port map (
      I0 => pwmIn,
      I1 => fsm,
      I2 => samplingCnt_reg(0),
      I3 => s00_axi_aresetn,
      O => \pwmMsrCnt[0]_i_1_n_0\
    );
\pwmMsrCnt[0]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => fsm,
      I1 => samplingCnt_reg(0),
...
\pwmMsr[31]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\samplingCnt[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4404"
    )
        port map (
...
\staleCnt[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0200FFFF"
    )
        port map (
...
\staleCnt[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
